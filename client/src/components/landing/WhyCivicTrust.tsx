...
export const WhyCivicTrust: React.FC = () => {
  const values = [
    {
      icon: <Camera className="w-5 h-5 text-bridge-gold-700" />,
    ...
    {
      icon: <SearchCheck className="w-5 h-5 text-bridge-gold-700" />,
    ...
    {
      icon: <GitFork className="w-5 h-5 text-bridge-gold-700" />,
    ...
    {
      icon: <Clock className="w-5 h-5 text-bridge-gold-700" />,
          ...
          {values.map((v) => (
            <Card key={v.title} hoverable className="flex flex-col justify-between">
              <CardBody className="p-6">
                <div className="w-10 h-10 rounded-xl bg-bridge-almond-50 border border-bridge-almond-200 flex items-center justify-center mb-4">
                  {v.icon}
                </div>
                <h3 className="text-base font-bold text-bridge-charcoal-900 mb-2">
                  {v.title}
                </h3>
                <p className="text-xs sm:text-sm text-bridge-charcoal-600 leading-relaxed mb-4">
                  {v.description}
                </p>
                <div className="pt-3 border-t border-bridge-almond-200/80 mt-auto">
